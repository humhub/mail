...
return array (
  ...
  'Conversation tags can be used to filter conversations and are only visible to you.' => 'A beszélgetési címkék használhatók a beszélgetések szűrésére, és csak Önnek láthatók.',
  'Conversations' => 'Beszélgetések',
  'Created At' => 'Létrehozva',
  'Created By' => 'Létrehozta',
  'Do you really want to delete this tag?' => 'Valóban törölni akarja ezt a címkét?',
  'Edit' => 'Szerkesztés',
  'Edit message...' => 'Üzenet szereksztése...',
  'Filters' => 'Szűrők',
  'Here you can manage your private conversation tags.' => 'Itt tudja kezelni a privát beszélgetések címkéit.',
  'Is Originator' => 'Kezdeményező',
  'Last Viewed' => 'Utoljára megtekintve',
  'Leave fields blank in order to disable a restriction.' => 'Hagyja üresen a mezőket a korlátozás kikapcsolásához.',
  'Manage Tags' => 'Címkék kezelése',
  'Max messages allowed per day' => 'Engedélyezett üzenetek maximális száma naponta',
  'Max number of messages allowed for a new user per day' => 'Engedélyezett üzeneteke száma naponta az új felhasználónak',
  ...
  'You are not allowed to start a conversation with {userName}!' => 'Önnek nem engedélyezett, hogy ezzel a felhasználóval beszélgetést kezdeményezzen: {userName}',
  'You cannot send a message to yourself!' => 'Nem küldhet üzenet önmagának',
  'You\'ve exceeded your daily amount of new conversations.' => 'Elérte a maximális napi üzenetek számát.',
  'created by {name}' => '{name} készítette',
  'with' => 'vele',
  '{n,plural,=1{# other} other{# others}}' => '{n,plural,=1{# egyéb} other{# egyebek}}',
);
