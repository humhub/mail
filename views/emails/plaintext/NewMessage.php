...
<?php echo Html::encode($originator->displayName); ?> <?php echo strip_tags(Yii::t('MailModule.views_emails_NewMessage', 'sent you a new message:')); ?> <?php echo Html::encode($message->title); ?>
